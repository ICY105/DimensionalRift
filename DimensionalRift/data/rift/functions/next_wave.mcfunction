summon item ~ ~1 ~1 {Tags:["rift_reward"],Team:"nexus",CustomName:"§5Unstable Matter",CustomNameVisible:1,NoGravity:1b,Item:{id:diamond,Count:1b,tag:{ench:[{lvl:1,id:71}],display:{Name:"§5Unstable Matter",Lore:["§3Generated from rifts."]}}}}
