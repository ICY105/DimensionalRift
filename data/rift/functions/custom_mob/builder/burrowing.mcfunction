...
execute if block ~ ~-0.25 ~ #rift:no_hitbox run tag @s remove rift.burrowing
execute if score $mobs.temp_1 rift.data = $nexus.in_0 rift.data run tag @s remove rift.burrowing
