...
execute unless block ^ ^-0.5 ^1 #rift:no_hitbox run tag @s remove rift.building
execute unless block ^ ^-1.5 ^1 #rift:no_hitbox run tag @s remove rift.building
execute if block ~ ~-0.25 ~ #rift:no_hitbox run tag @s remove rift.building
