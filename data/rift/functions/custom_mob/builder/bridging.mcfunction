...
execute if block ^ ^1.5 ^1 #rift:no_hitbox run function rift:custom_mob/builder/bridging_2 
execute unless block ^ ^1.5 ^1 #rift:no_hitbox positioned ~ ~1 ~ run function rift:custom_mob/builder/breaking 
