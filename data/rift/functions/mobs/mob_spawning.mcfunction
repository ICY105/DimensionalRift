...
#Evoker
execute if entity @s[tag=nexus_group_evoker] run summon evoker ~2 ~1 ~ {Tags:["nexus_mob"],Attributes:[{Name:generic.maxHealth,Base:18},{Name:generic.movementSpeed,Base:0},{Name:generic.knockbackResistance,Base:1}],Health:18.0f,Team:"attackers"}
execute if entity @s[tag=nexus_group_evoker] run summon evoker ~ ~1 ~-2 {Tags:["nexus_mob"],Attributes:[{Name:generic.maxHealth,Base:18},{Name:generic.movementSpeed,Base:0},{Name:generic.knockbackResistance,Base:1}],Health:18.0f,Team:"attackers"}
