...
loot replace entity @e[tag=rift.new,tag=rift.bow,tag=!rift.commander,distance=..3] weapon.mainhand loot rift:equipment/bow_0
loot replace entity @e[tag=rift.new,tag=rift.bow,tag=rift.commander,distance=..3] weapon.mainhand loot rift:equipment/bow_1
...
loot replace entity @e[tag=rift.new,tag=rift.armor,tag=rift.commander,distance=..3] armor.chest loot rift:equipment/golden_chestplate
